...
-- The employee table has one-to-one relationship
...
-- The dept_emp table has many-many relationship, so two primary keys are needed
...
-- The salaries table has one-to-one relationship
